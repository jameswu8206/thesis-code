...
int main(void) {
    ...
    // --- Setpoints & Bounds ---
    OSQPFloat x_current[NX] = {1.0,0.0};//initial point
    OSQPFloat x_target[NX] = { 0.1,0.0};//target point
    ...
    const OSQPFloat eta_pri = 0.03; // CMoN Gatekeeper Tolerance
    #if FORMULATION == OPT_CONDENSED
